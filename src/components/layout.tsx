...
export function Layout() {
  return (
    <div className="min-h-screen ">
      <nav className="bg-white  border-t-8 border-t-cyan-50 flex items-center justify-center ">
        ...
        <div className="flex flex-col  p-3  w-1/2 border-b border-gray-300 shadow-[0_2px3px-2px_rgba(0,0,0,0.1)] rounded-xs">
          ...
          <Link to="/sobre" className="text-black font-bold rounded transition-transform duration-200 hover:scale-105">
            Sobre
          </Link>

          <Link to="/contato" className="text-black font-bold rounded transition-transform duration-200 hover:scale-105">
            Contato
          </Link>
